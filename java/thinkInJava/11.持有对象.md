...
- [1. 第 11 章 持有对象](#1-第-11-章-持有对象)
  - [1.1. 泛型和类型安全的容器](#11-泛型和类型安全的容器)
  - [1.2. 基本概念](#12-基本概念)
  - [1.3. 添加一组元素](#13-添加一组元素)
  - [1.4. 容器打印](#14-容器打印)
  - [1.5. List](#15-list)
    - [1.5.1. 基本操作](#151-基本操作)
  - [1.6. 迭代器](#16-迭代器)
    - [1.6.1. ListIterator](#161-listiterator)
  - [1.7. LinkedList](#17-linkedlist)
  - [1.8. Stack](#18-stack)
  - [1.9. Set](#19-set)
  - [1.10. Map](#110-map)
  - [1.11. Queue](#111-queue)
    - [1.11.1. PriorityQueue](#1111-priorityqueue)
  - [1.12. Foreach 与迭代器](#112-foreach-与迭代器)
